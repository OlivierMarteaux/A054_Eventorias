...
//    }
//
//    // Capture button (example)
////    val outputDir = context.getExternalFilesDir(Environment.DIRECTORY_PICTURES)!!
////    IconButton(
////        onClick = { takePicture(context, imageCapture, onImageCapture ) },
...
////            val result = captureImage(context,imageCapture, outputDir)
////            result?.let { onImageCapture(it) }
////        }
////    }) {
