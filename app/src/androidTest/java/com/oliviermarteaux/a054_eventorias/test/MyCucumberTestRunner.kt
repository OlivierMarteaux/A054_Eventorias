...
@CucumberOptions(
    ...
    glue = [
        "com.oliviermarteaux.a054_eventorias.cucumber.steps",
        "com.oliviermarteaux.a054_eventorias.di",
    ],
    tags = "",
    plugin = [
        "pretty",                               // console output
        "summary",                              // summary at the end
        "html:/data/data/com.oliviermarteaux.a054_eventorias/files/cucumber-report.html",  // HTML file on device
        "json:/data/data/com.oliviermarteaux.a054_eventorias/files/cucumber-report.json"   // JSON for CI
    ]
)
